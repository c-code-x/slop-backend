...
import com.slop.slopbackend.utility.SecurityUtil;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        final String authorizationHeader = request.getHeader(SecurityUtil.HEADER_STRING);
        String emailId = null, jwt = null;
        if (authorizationHeader != null && authorizationHeader.startsWith(SecurityUtil.TOKEN_PREFIX)) {
